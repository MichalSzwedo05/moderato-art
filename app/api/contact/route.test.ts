...
describe("POST /api/contact", () => {
  ...
  it("keeps the saved submission accepted when confirmation delivery fails", async () => {
    enableForm();
    enableNotifications();
  ...
  it("keeps the saved submission accepted when confirmation delivery times out", async () => {
    enableForm();
    enableNotifications();
    vi.useFakeTimers();
