...
The following illustrative stock photographs are local copies downloaded from Unsplash on 2026-07-24. They are used under the [Unsplash License](https://unsplash.com/license). The original `images.unsplash.com` asset identifier is retained for each file so the original listing and photographer can be retrieved if attribution is required for a future publication.
