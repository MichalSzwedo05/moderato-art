...
- `POST /api/admin/submissions/export` returns a UTF-8 XML attachment with escaped values, explicit null fields, stable newest-first ordering, and no external entities.
