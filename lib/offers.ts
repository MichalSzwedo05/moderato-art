export const offers = [
  ...
  {
    audience: "Dla osób zmagających się z zaburzeniami głosu",
    contactMode: "form",
    description: "Indywidualne konsultacje wspierające zdrowie, swobodę i naturalne brzmienie głosu.",
    id: "rehabilitacja-zaburzen-glosu",
    lessonType: "rehabilitacja-zaburzen-glosu",
    modalParagraphs: [
    ...
    number: "04",
    subtitle: "Indywidualne konsultacje",
    title: "Rehabilitacja zaburzeń głosu",
  },
] as const;
...
export const lessonTypeTabs: Record<ContactLessonType, string> = {
  "rytmika": "Rytmisolki",
